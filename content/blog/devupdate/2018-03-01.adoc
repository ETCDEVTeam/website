---
layout: article
title: March 1st Dev Update
published: true
date: 01.03.2018 09:00
---
...
* https://github.com/ethereumproject/ECIPs/pull/87[ECIP-1041] has passed human consensus and is now either implemented or scheduled for implementation in the major clients. Woohoo!!
